...
def test_periods_overlap_with_open_ended() -> None:
    a = StatusPeriod("2026-01-01", "2026-01-10")
    b = StatusPeriod("2026-01-10", "2026-01-20")
    assert periods_overlap(a, b)
    assert periods_overlap(
        StatusPeriod("2026-01-01", None),
        StatusPeriod("2026-06-01", "2026-06-02"),
    )
    assert not periods_overlap(
        StatusPeriod("2026-01-01", "2026-01-10"),
        StatusPeriod("2026-01-11", None),
    )
