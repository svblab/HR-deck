...
class TemplateLibraryDialog(QDialog):
    def __init__(
        ...
        self._upload_btn.setVisible(self._can_manage)
        self._archive_btn.setVisible(self._can_manage)
        self._restore_btn.setVisible(self._can_manage)
        self._generate_btn.setVisible(self._can_use)
