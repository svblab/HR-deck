...
— каноническая интеграционная ветка (в репозитории защищённая ветка называется
`master`; в `ANCHOR_PROTOCOL.md` она может упоминаться как `main` — имеется в
виду та же protected branch).
